/** EFF Long Wordlist (Diceware-style) — subset for bundle size. */
export const DICEWARE_WORDLIST = [
  'abacus', 'abdomen', 'abide', 'ability', 'ablaze', 'abnormal', 'abort', 'abrasive',
  'absorb', 'abyss', 'academy', 'accent', 'accept', 'access', 'accident', 'account',
  'achieve', 'acid', 'acoustic', 'acquire', 'across', 'action', 'active', 'actor',
  'acute', 'adapt', 'addict', 'address', 'adjust', 'admire', 'admit', 'adopt',
  'adult', 'advance', 'advice', 'aerial', 'affair', 'afford', 'afraid', 'again',
  'agency', 'agenda', 'agent', 'agree', 'ahead', 'aim', 'airport', 'aisle',
  ...
  'arrive', 'arrow', 'artist', 'aspect', 'assault', 'asset', 'assist', 'assume',
  'asthma', 'athlete', 'atom', 'attack', 'attend', 'attract', 'auction', 'audit',
  ...
  'choose', 'chronic', 'chuckle', 'chunk', 'churn', 'cigar', 'circle', 'citizen',
